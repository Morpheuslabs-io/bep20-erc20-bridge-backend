...
async function swap(amount) {
    ...
    amount = web3.utils.toWei(`${amount}`, "ether");
    let nonce = await web3.eth.getTransactionCount(account.address);
    let payload = await swapContract.methods.swapETH2BSC(amount).encodeABI();
